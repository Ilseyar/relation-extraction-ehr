...
class MeshSemanticTypesFeature:
    ...
    def get_feature_names(self):
        return 'mesh_semantic_type'

    def create_mesh_semantic_type_feature(self, relations):
        features = []
    ...
    def transform(self, relations):
        return self.create_mesh_semantic_type_feature(relations)
